...
const Accounts = () => (
  <Box mt='4'>
    <SimpleGrid columns={[1, 1, 3]} spacing={8} maxW='5xl' mx={{ base: '4', md: '8', lg: 'auto' }}>
      ...
      <Box bg='pink.200' p='6' rounded='md' align='center' _hover={{ boxShadow: '0px 5px #702459 inset' }}>
      ...
      <Box bg='purple.200' p='6' rounded='md' align='center' _hover={{ boxShadow: '0px 5px #44337A inset' }}>

...
const Accounts = () => (
  <Box mt='6'>
    <SimpleGrid columns={[1, 1, 3]} spacing={8} maxW='5xl' mx={{ base: '4', md: '8', lg: 'auto' }}>
      <Tilt tiltMaxAngleX={15} tiltMaxAngleY={15} style={{ transformStyle: 'preserve-3d' }}>
        <Box
          p='6'
          bg='teal.200'
          rounded='md'
        ...
        >
          ...
          <Circle bg='teal.100' style={{ transformStyle: 'preserve-3d' }}>
            <Icon as={FcGraduationCap} boxSize='40' transform='translateZ(20px)' />
          </Circle>
        </Box>
      </Tilt>
      <Tilt tiltMaxAngleX={15} tiltMaxAngleY={15} style={{ transformStyle: 'preserve-3d' }}>
        ...
        >
          ...
          <Circle bg='pink.100' style={{ transformStyle: 'preserve-3d' }}>
            <Icon as={FcBusinessman} boxSize='40' transform='translateZ(20px)' />
          </Circle>
        </Box>
      </Tilt>
      <Tilt tiltMaxAngleX={15} tiltMaxAngleY={15} style={{ transformStyle: 'preserve-3d' }}>
        ...
        >
          ...
          <Circle bg='purple.100' style={{ transformStyle: 'preserve-3d' }}>
            <Icon as={FcBusinesswoman} boxSize='40' transform='translateZ(20px)' />
          </Circle>
        </Box>
      </Tilt>
    </SimpleGrid>

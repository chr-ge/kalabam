    ...
    <Container maxW='5xl' my='10'>
      ...
      <Stack spacing={8}>
        ...
        <Stack mb='10'>
          ...
          <Link
            href='#limiting-use-disclosure-retention'
            fontSize='lg'
            variant='kalabam'
            textTransform='uppercase'
          >
          ...
          <Link
            href='#safeguarding-customer-information'
            fontSize='lg'
            variant='kalabam'
            textTransform='uppercase'
          >
        ...
        <Box>
          <Heading mb='4' fontSize='2xl' id='identifying-purposes'>
            2. Identifying Purposes
          </Heading>
          <Text>
        ...
        <Box>
          <Heading mb='4' fontSize='2xl' id='consent'>
            3. Consent
          </Heading>
          <Text>
        ...
        <Box>
          <Heading mb='4' fontSize='2xl' id='limiting-collection'>
            4. Limiting Collection
          </Heading>
          <Text>
        ...
        <Box>
          <Heading mb='4' fontSize='2xl' id='limiting-use-disclosure-retention'>
            5. Limiting Use, Disclosure and Retention
          </Heading>
          <Text>
        ...
        <Box>
          <Heading mb='4' fontSize='2xl' id='accuracy'>
            6. Accuracy
          </Heading>
          <Text>
        ...
        <Box>
          <Heading mb='4' fontSize='2xl' id='safeguarding-customer-information'>
            7. Safeguarding Customer Information
          </Heading>
          <Text>
        ...
        <Box>
          <Heading mb='4' fontSize='2xl' id='openness'>
            8. Openness
          </Heading>
          <Text>
        ...
        <Box>
          <Heading mb='4' fontSize='2xl' id='customer-access'>
            9. Customer Access
          </Heading>
          <Text>
        ...
        <Box>
          <Heading mb='4' fontSize='2xl' id='handling-customer'>
            10. Handling Customer Complaints and Suggestions
          </Heading>
          <Text>

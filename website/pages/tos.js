...
const Tos = () => (
  <Layout title='Terms of Service | Kalabam'>
    <Container maxW='5xl' my='10'>
      <Heading mb='2'>Terms of Service</Heading>
      ...
      <Stack spacing={8}>
        <Stack mb='10'>
          ...
          <Link
            href='#links-to-third-party-websites'
            fontSize='lg'
            variant='kalabam'
            textTransform='uppercase'
          >
          ...
          <Link
            href='#comments-feedback-submissions'
            fontSize='lg'
            variant='kalabam'
            textTransform='uppercase'
          >
          ...
          <Link
            href='#disclaimer-limitation-liability'
            fontSize='lg'
            variant='kalabam'
            textTransform='uppercase'
          >
        ...
        <Box>
          <Heading mb='4' fontSize='2xl' id='introduction'>
            1. Introduction
          </Heading>
          <Text>
            This website is operated by Kalabam. The terms “we”, “us”, and “our”
            refer to Kalabam. The use of our website is subject to the following
            terms and conditions of use, as amended from time to time (the
            “Terms”). The Terms are to be read together by you with any terms,
            conditions or disclaimers provided in the pages of our website.
            Please review the Terms carefully. The Terms apply to all users of
            our website, including without limitation, users who are browsers,
            ...
            the Terms or our Privacy Policy, you are not authorized to access
            our website, use any of our website’s services or place an order on
            our website.
          </Text>
        </Box>
        <Box>
          <Heading mb='4' fontSize='2xl' id='use-of-website'>
            2. Use of our Website
          </Heading>
          <Text mb='4'>
        ...
        <Box>
          <Heading mb='4' fontSize='2xl' id='general-conditions'>
            3. General Conditions
          </Heading>
          <Text mb='4'>
        ...
        <Box>
          <Heading mb='4' fontSize='2xl' id='links-to-third-party-websites'>
            4. Links to Third-Party Websites
          </Heading>
          <Text>
        ...
        <Box>
          <Heading mb='4' fontSize='2xl' id='comments-feedback-submissions'>
            5. Use Comments, Feedback, and Other Submissions
          </Heading>
          <Text mb='4'>
        ...
        <Box>
          <Heading mb='4' fontSize='2xl' id='personal-information'>
            6. Your Personal Information
          </Heading>
          <Text>
            Please see our{' '}
        ...
        <Box>
          <Heading mb='4' fontSize='2xl' id='errors-omissions'>
            7. Errors and Omissions
          </Heading>
          <Text mb='4'>
        ...
        <Box>
          <Heading mb='4' fontSize='2xl' id='disclaimer-limitation-liability'>
            8. Disclaimer and Limitation of Liability
          </Heading>
          <Text mb='4'>
        ...
        <Box>
          <Heading mb='4' fontSize='2xl' id='indemnification'>
            9. Indemnification
          </Heading>
          <Text>
        ...
        <Box>
          <Heading mb='4' fontSize='2xl' id='entire-agreement'>
            10. Entire Agreement
          </Heading>
          <Text>
        ...
        <Box>
          <Heading mb='4' fontSize='2xl' id='waiver'>
            11. Waiver
          </Heading>
          <Text>
        ...
        <Box>
          <Heading mb='4' fontSize='2xl' id='headings'>
            12. Headings
          </Heading>
          <Text>Any headings and titles herein are for convenience only.</Text>
        </Box>
        <Box>
          <Heading mb='4' fontSize='2xl' id='severability'>
            13. Severability
          </Heading>
          <Text>
        ...
        <Box>
          <Heading mb='4' fontSize='2xl' id='governing-law'>
            14. Governing Law
          </Heading>
          <Text>
            ...
            Province of Quebec without regard to its conflict of law rules. Any
            disputes, actions or proceedings relating to the Terms or your
            access to or use of our website must be brought before the courts of
            the Province of Quebec in the City of Montreal,
          </Text>
          <Text>
            Quebec and you irrevocably consent to the exclusive jurisdiction and
            venue of such courts.
          </Text>
        </Box>
        <Box>
          <Heading mb='4' fontSize='2xl' id='questions-concerns'>
            15. Questions or Concerns
          </Heading>
          <Text>
            Please send all questions, comments and feedback to us at:{' '}
            <Link href='mailto:hello@kalabam.com' variant='kalabam'>
              hello@kalabam.com
            </Link>
          </Text>
        </Box>
